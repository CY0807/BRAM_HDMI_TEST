...
synth_design -top top_hdmi_test -part xc7a35tfgg484-2L


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef top_hdmi_test.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file top_hdmi_test_utilization_synth.rpt -pb top_hdmi_test_utilization_synth.pb"
